...
import { ShieldCheck, Download, ExternalLink, Clock } from 'lucide-react';
...
export const DownloadRedirect: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-10 bg-white dark:bg-[#111] text-zinc-800 dark:text-zinc-200 transition-colors duration-300">
      <SEO title="Descargando Archivo" description="Generando enlace seguro..." noIndex={true} />
      ...
      <div className="max-w-md w-full bg-white dark:bg-[#1a1a1a] p-8 rounded-xl shadow-xl border border-gray-200 dark:border-[#333] text-center relative overflow-hidden mx-4 z-10">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mb-8 text-sm">
            {ready 
                ? 'Gracias por tu paciencia. Tu archivo está listo.' 
        ...
        <div className="mt-6 pt-4 border-t border-gray-100 dark:border-[#333] text-xs text-zinc-400 flex items-center justify-center gap-1">
            <ExternalLink size={10} />
            <span>RomXD Secure Gateway</span>
        </div>
      </div>
